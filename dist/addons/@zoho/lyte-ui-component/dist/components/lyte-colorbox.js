...
var LyteColorbox = {
	 ...
	 * @param {Array.<Object>|Array} values - The list of objects or single object that will be added to the current related element list
	 *
	 */
	add : function(values){
	 ...
	 * @param {HTMLElement} element - The current visible element in colorbox
	 *
	 */
	 ...
	 * @param {HTMLElement} parent - The parent element containing the loading icon
	 *
	 */
	 ...
	 * @param {HTMLElement} element - The element from which the properties are extracted
	 *
	 */
	 ...
	 * @param {HTMLElement} element - The current element to be opened
	...
	launch : function(element,event) {
		...
		if (!LyteColorbox._closing) {
			...
			if (!LyteColorbox._open) {
				...
				// },100)
				LyteColorbox._content.focus();
				LyteColorbox._content && LyteColorbox._title && LyteColorbox._content.setAttribute('aria-labelledby',LyteColorbox._title.getAttribute('id'));
				//console.log(LyteColorbox)
	 ...
	 * @param {Object} element - HTMLElement or an object which contains the values that will be used to load the item to be shown in the colorbox
	...
	load : function(element, init){
		...
		LyteColorbox._component.setData('ltPropContent',element);
	 ...
	 * @param {HTMLElement} photo - The image element
	 ...
	 * @param {HTMLElement} div - The div that contains the loading icon
	 *
	 */
	 ...
	 * @param {HTMLElement} elementMovingOutOfView - The div containing the image
	...
	close : function () {
		if (LyteColorbox._open && !LyteColorbox._closing) {
			...
			if(LyteColorbox._zoomIn){
				...
				LyteColorbox._zoomOut.setAttribute('aria-disabled',false);
			}
			...
			if(LyteColorbox._zoomOut && LyteColorbox._component.getData( 'ltPropType' ) != 'image'){
				...
				LyteColorbox._zoomOut.setAttribute('aria-disabled',true);
			}
	 ...
	 * @param {HTMLElement} ele - Image element
	 *
	 */
	...
	wheel : function( evt ){
        ...
        if(LyteColorbox._zoomOut){
        	LyteColorbox._zoomOut.classList.remove('lyteColorboxDisabled');
        	LyteColorbox._zoomOut.setAttribute('aria-disabled',false);	
        }
		if(LyteColorbox._reset){
			LyteColorbox._reset.classList.remove('lyteColorboxDisabled');
			LyteColorbox._reset.setAttribute('aria-disabled',false);
		}
	},
		...
		if(LyteColorbox._clickNumber <= LyteColorbox._component.getData('ltPropZoomClickNumber')){
			...
			$L.fastdom.measure( function(){
				...
				if(LyteColorbox._clickNumber == 1 || (LyteColorbox._zoomOut && LyteColorbox._zoomOut.classList.contains('lyteColorboxDisabled')) || (LyteColorbox._reset && LyteColorbox._reset.classList.contains('lyteColorboxDisabled'))){
					LyteColorbox._zoomOut && LyteColorbox._zoomOut.classList.remove('lyteColorboxDisabled') && LyteColorbox._zoomOut.setAttribute('aria-disabled',false); 
					LyteColorbox._reset && LyteColorbox._reset.classList.remove('lyteColorboxDisabled') && LyteColorbox._reset.setAttribute('aria-disabled',false); 
				}
				if(LyteColorbox._clickNumber == LyteColorbox._component.getData('ltPropZoomClickNumber')){
					LyteColorbox._zoomIn && LyteColorbox._zoomIn.classList.add('lyteColorboxDisabled') && LyteColorbox._zoomIn.setAttribute('aria-disabled',true);
				}
	...
	zoomOut : function(){
		...
		if(LyteColorbox._zoom){		//if the picture is zoomed using the util function then reset it.
			...
			LyteColorbox._clickNumber = 0;
			LyteColorbox._zoomedThroughUtil = false;
			LyteColorbox._zoomOut && LyteColorbox._zoomOut.classList.add('lyteColorboxDisabled') && LyteColorbox._zoomOut.setAttribute('aria-disabled',true);
			LyteColorbox._reset && LyteColorbox._reset.classList.add('lyteColorboxDisabled') && LyteColorbox._reset.setAttribute('aria-disabled',true);
			if(LyteColorbox._zoomIn && LyteColorbox._zoomIn.classList.contains('lyteColorboxDisabled')){
				LyteColorbox._zoomIn.classList.remove('lyteColorboxDisabled') && LyteColorbox._zoomIn.setAttribute('aria-disabled',false);
			}
			...
			if(LyteColorbox._clickNumber >= 0 && LyteColorbox._clickNumber < LyteColorbox._component.getData('ltPropZoomClickNumber')){
				...
				$L.fastdom.measure( function(){
					...
					if(LyteColorbox._clickNumber == LyteColorbox._component.getData('ltPropZoomClickNumber') - 1){
						LyteColorbox._zoomIn && LyteColorbox._zoomIn.classList.remove('lyteColorboxDisabled') && LyteColorbox._zoomIn.setAttribute('aria-disabled',false);
					}
					LyteColorbox.setPercentage(undefined, curZoom - zoomBy);
	...
	reset : function( elementToBeReset , onclick ) {
		...
		if( elementToBeReset.classList.contains(LyteColorbox._prefix+"Photo" ) && ( LyteColorbox._clickNumber > 0 || LyteColorbox._zoomedThroughUtil ) ){
			...
			if(LyteColorbox._zoomIn){
				LyteColorbox._zoomIn.classList.remove('lyteColorboxDisabled');
				LyteColorbox._zoomIn.setAttribute('aria-disabled',false)
			}
			...
			if(LyteColorbox._reset){
				LyteColorbox._reset.classList.add('lyteColorboxDisabled');
				LyteColorbox._reset.setAttribute('aria-disabled',true)
			}
...
_template:"<template tag-name=\"lyte-colorbox\"> <template is=\"if\" value=\"{{expHandlers(ltPropType,'===','custom')}}\"><template case=\"true\"> <template is=\"if\" value=\"{{ltPropYield}}\"><template case=\"true\"> <lyte-yield yield-name=\"colorBoxYield\" lt-cb-content-type=\"{{ltPropContent.lytecboxType}}\"></lyte-yield> </template><template case=\"false\"> <div id=\"lyteColorbox\" class=\"lyteColorbox lyteCBox\"> <div class=\"lyteColorboxFreezeLayer lyteCBoxOverlay\"></div> <div class=\"lyteColorboxWrapper\"> <template is=\"if\" value=\"{{expHandlers(isIframe,'!')}}\"><template case=\"true\"> <div class=\"lyteColorboxUtilDiv\"> <span class=\"lyteCBoxZoomOut lyteColorboxZoomOut lyteColorboxDisabled\" lt-prop-title=\"Zoom Out\" lt-prop-tooltip-config=\"{&quot;position&quot; : &quot;bottom&quot;,&quot;appearance&quot; : &quot;box&quot;,&quot;margin&quot; : 5}\"></span> <span class=\"lyteCBoxReset lyteColorboxReset lyteColorboxDisabled\" lt-prop-title=\"Reset Zoom\" lt-prop-tooltip-config=\"{&quot;position&quot; : &quot;bottom&quot;,&quot;appearance&quot; : &quot;box&quot;,&quot;margin&quot; : 5}\"></span> <span class=\"lyteCBoxZoomIn lyteColorboxZoomIn\" lt-prop-title=\"Zoom In\" lt-prop-tooltip-config=\"{&quot;position&quot; : &quot;bottom&quot;,&quot;appearance&quot; : &quot;box&quot;,&quot;margin&quot; : 5}\"></span> </div> </template></template> <div class=\"lyteColorboxContent lyteCBoxContent\"> <span class=\"lyteColorboxLoadingImg\"></span> </div> <div class=\"lyteColorboxHeader\"> <div class=\"lyteColorboxTitle lyteCBoxTitle\"></div> <template is=\"if\" value=\"{{download}}\"><template case=\"true\"> <div class=\"lyteColorboxDownloadDiv lyteCBoxDownload\"> <span class=\"lyteColorboxDownloadImg\"></span> </div> </template></template> </div> </div> <div class=\"lyteColorboxCloseIcon lyteCBoxClose\"></div> <template is=\"if\" value=\"{{ltPropNavIcon}}\"><template case=\"true\"> <div class=\"lyteColorboxIconDiv lyteCBoxPrevious\"> <div class=\"lyteColorboxPreviousIcon\"></div> </div> <div class=\"lyteColorboxIconDiv lyteCBoxNext\"> <div class=\"lyteColorboxNextIcon\"></div> </div> </template></template> <template is=\"if\" value=\"{{ltPropThumbnail}}\"><template case=\"true\"> <div class=\"lyteColorboxThumbOuterWrapper\"> <div class=\"lyteColorboxThumbnails\" __click=\"{{action(&quot;clickOnThumbnails&quot;,event)}}\"> <div class=\"lyteColorboxThumbInnerWrapper\"> <template is=\"for\" items=\"{{thumbnails}}\" item=\"item\" index=\"index\"> <div class=\"{{lyteUiAddShowClass(ltPropAddOrientation,'lyteColorboxThumb','addedOrientation')}}\" data-thumb-val=\"{{lyteUiSetIndexString(index,thumbnails.length)}}\"> <template is=\"if\" value=\"{{ifEquals(item.type,&quot;photo&quot;)}}\"><template case=\"true\"> <img src=\"{{item.lytecboxHref}}\"> </template><template case=\"false\"><template is=\"if\" value=\"{{lyteUiIfEqualsAny(item.type,&quot;iframe&quot;,&quot;custom&quot;)}}\"><template case=\"true\"><template is=\"if\" value=\"{{item.lytecboxThumbnail}}\"><template case=\"true\"> <img class=\"lyteCBoxFavImg\" src=\"{{item.lytecboxThumbnail}}\"> </template><template case=\"false\"> <div class=\"lyteCBoxIframeWrap\"> <div class=\"lyteCBoxIframeIcon\"></div> <div class=\"lyteCBoxIframeLabel\">{{item.format}}</div> </div> </template></template> </template></template></template></template> </div> </template> </div> </div> </div> </template></template> </div> </template></template> </template><template case=\"false\"> <template is=\"if\" value=\"{{ltPropYield}}\"><template case=\"true\"> <lyte-yield yield-name=\"colorBoxYield\"></lyte-yield> </template><template case=\"false\"> <lyte-colorbox-container> <lyte-colorbox-header> <lyte-colorbox-title></lyte-colorbox-title> <template is=\"if\" value=\"{{download}}\"><template case=\"true\"> <lyte-colorbox-download> <span class=\"lyteColorboxDownloadImg\"></span> </lyte-colorbox-download> </template></template> <lyte-colorbox-close></lyte-colorbox-close> </lyte-colorbox-header> <lyte-colorbox-content> </lyte-colorbox-content> <template is=\"if\" value=\"{{ltPropNavIcon}}\"><template case=\"true\"> <lyte-colorbox-previous> <div class=\"lyteColorboxPreviousIcon\"></div> </lyte-colorbox-previous> <lyte-colorbox-next> <div class=\"lyteColorboxNextIcon\"></div> </lyte-colorbox-next> </template></template> <lyte-colorbox-description> </lyte-colorbox-description> <div class=\"lyteColorboxUtilDiv\"> <lyte-colorbox-zoomin lt-prop-title=\"Zoom In\" lt-prop-tooltip-config=\"{&quot;position&quot; : &quot;bottom&quot;,&quot;appearance&quot; : &quot;box&quot;,&quot;margin&quot; : 5}\"></lyte-colorbox-zoomin> <lyte-colorbox-reset class=\"lyteColorboxDisabled\" lt-prop-title=\"Reset Zoom\" lt-prop-tooltip-config=\"{&quot;position&quot; : &quot;bottom&quot;,&quot;appearance&quot; : &quot;box&quot;,&quot;margin&quot; : 5}\"></lyte-colorbox-reset> <lyte-colorbox-zoomout lt-prop-title=\"Zoom Out\" lt-prop-tooltip-config=\"{&quot;position&quot; : &quot;bottom&quot;,&quot;appearance&quot; : &quot;box&quot;,&quot;margin&quot; : 5}\"></lyte-colorbox-zoomout> </div> <template is=\"if\" value=\"{{ltPropThumbnail}}\"><template case=\"true\"> <lyte-colorbox-thumbnail> <div class=\"lyteColorboxThumbnails\" __click=\"{{action(&quot;clickOnThumbnails&quot;,event)}}\"> <div class=\"lyteColorboxThumbInnerWrapper\"> <template is=\"for\" items=\"{{thumbnails}}\" item=\"item\" index=\"index\"> <div class=\"{{lyteUiAddShowClass(ltPropAddOrientation,'lyteColorboxThumb','addedOrientation')}}\" data-thumb-val=\"{{lyteUiSetIndexString(index,thumbnails.length)}}\"> <template is=\"if\" value=\"{{ifEquals(item.type,&quot;photo&quot;)}}\"><template case=\"true\"> <img src=\"{{item.lytecboxHref}}\"> </template><template case=\"false\"><template is=\"if\" value=\"{{lyteUiIfEqualsAny(item.type,&quot;iframe&quot;,&quot;custom&quot;)}}\"><template case=\"true\"><template is=\"if\" value=\"{{item.lytecboxThumbnail}}\"><template case=\"true\"> <img class=\"lyteCBoxFavImg\" src=\"{{item.lytecboxThumbnail}}\"> </template><template case=\"false\"> <div class=\"lyteCBoxIframeWrap\"> <div class=\"lyteCBoxIframeIcon\"></div> <div class=\"lyteCBoxIframeLabel\">{{item.format}}</div> </div> </template></template> </template></template></template></template> </div> </template> </div> </div> </lyte-colorbox-thumbnail> </template></template> </lyte-colorbox-container> </template></template> </template></template> </template>",
_dynamicNodes : [{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"insertYield","position":[1]}]},"false":{"dynamicNodes":[{"type":"attr","position":[1,3,1]},{"type":"if","position":[1,3,1],"cases":{"true":{"dynamicNodes":[]}},"default":{}},{"type":"attr","position":[1,3,5,3]},{"type":"if","position":[1,3,5,3],"cases":{"true":{"dynamicNodes":[]}},"default":{}},{"type":"attr","position":[1,7]},{"type":"if","position":[1,7],"cases":{"true":{"dynamicNodes":[]}},"default":{}},{"type":"attr","position":[1,9]},{"type":"if","position":[1,9],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1,1]},{"type":"attr","position":[1,1,1,1]},{"type":"for","position":[1,1,1,1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1]},{"type":"if","position":[1,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]}]},"false":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"if","position":[0],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"if","position":[0],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]}]},"false":{"dynamicNodes":[{"type":"text","position":[1,3,0]}]}},"default":{}}]}},"default":{}}]}},"default":{}}]}]}},"default":{}}]}},"default":{}}]},"false":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"insertYield","position":[1]}]},"false":{"dynamicNodes":[{"type":"componentDynamic","position":[1,1,1]},{"type":"attr","position":[1,1,3]},{"type":"if","position":[1,1,3],"cases":{"true":{"dynamicNodes":[{"type":"componentDynamic","position":[1]}]}},"default":{}},{"type":"componentDynamic","position":[1,1,5]},{"type":"componentDynamic","position":[1,1]},{"type":"componentDynamic","position":[1,3]},{"type":"attr","position":[1,5]},{"type":"if","position":[1,5],"cases":{"true":{"dynamicNodes":[{"type":"componentDynamic","position":[1]},{"type":"componentDynamic","position":[3]}]}},"default":{}},{"type":"componentDynamic","position":[1,7]},{"type":"componentDynamic","position":[1,9,1]},{"type":"componentDynamic","position":[1,9,3]},{"type":"componentDynamic","position":[1,9,5]},{"type":"attr","position":[1,11]},{"type":"if","position":[1,11],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1,1]},{"type":"attr","position":[1,1,1,1]},{"type":"for","position":[1,1,1,1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1]},{"type":"if","position":[1,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]}]},"false":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"if","position":[0],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"if","position":[0],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]}]},"false":{"dynamicNodes":[{"type":"text","position":[1,3,0]}]}},"default":{}}]}},"default":{}}]}},"default":{}}]},{"type":"componentDynamic","position":[1]}]}},"default":{}},{"type":"componentDynamic","position":[1]}]}},"default":{}}]}},"default":{}}],
_observedAttributes :["ltPropHeight","ltPropWidth","ltPropOverlayClose","ltPropYield","ltPropSelectors","ltPropLoop","ltPropArrowKey","ltPropZoomBy","ltPropEscKey","ltPropImgError","ltPropAnimation","ltPropThumbnail","ltPropThumbnailNumber","ltPropZoomClickNumber","ltPropType","ltPropMinScale","ltPropMaxScale","ltPropWheelZoom","ltPropZoomPosition","ltPropAddOrientation","ltPropContent","ltPropNavIcon","currentEle","thumbnails","triggerSetThumbnail","isIframe","download"],
	...
	data : function(){
		return {
			...
			'ltPropContent' : Lyte.attr('object',{default:{}}),
			'ltPropNavIcon' : Lyte.attr('boolean',{default : true}),
	...
	setAriaAttributes : function(){	
		...
		if(this._close){
			this._close.setAttribute('tabindex',6);
			this._close.setAttribute('role','button');
			this._close.setAttribute('aria-label','close');
		}
		
		if(this._download){
			this._download.setAttribute('tabindex',5);
			this._download.setAttribute('role','download');
			this._download.setAttribute('aria-label','download');
		}

		if(this._next){
			this._next.setAttribute('tabindex',3);
			this._next.setAttribute('role','button');
			this._next.setAttribute('aria-label','next');
		}
		
		if(this._prev){
			this._prev.setAttribute('tabindex',2);
			this._prev.setAttribute('role','button');
			this._prev.setAttribute('aria-label','previous');
		}

		if(this._reset){
			this._reset.setAttribute('tabindex',4);
			this._reset.setAttribute('role','button');
			this._reset.setAttribute('aria-label','reset');
		}

		if(this._zoomOut){
			this._zoomOut.setAttribute('tabindex',4);
			this._zoomOut.setAttribute('role','button');
			this._zoomOut.setAttribute('aria-label','zoom out');
		}

		if(this.zoomIn){
			this._zoomIn.setAttribute('tabindex',4);
			this._zoomIn.setAttribute('role','button');
			this._zoomIn.setAttribute('aria-label','zoom in');
		}
		...
		//this._title.setAttribute('id',this._content.getAttribute('id')+'_title');
		//this._content.setAttribute('aria-labelledby',this._title.getAttribute('id'));
	},
	...
	intialFunc : function(){
		...
		if( type === 'custom' ) {
			...
			if( ele.length > 0 ) {
				if(ele.length === 1){
					this.setData('ltPropNavIcon',false);
				}
	...
	setupColorBoxForImages: function() {
		...
		if( listOfItemsThatOpenColorbox.length > 0 ) {
			...
			if(listOfItemsThatOpenColorbox.length === 1){
				this.setData('ltPropNavIcon',false);
			}
	...
	utilDivEvents : function(){
		if(!this.getData('isIframe')){
			...
			if(LyteColorbox._zoomIn){
				...
				LyteColorbox._zoomIn.setAttribute('tabindex',4);
				LyteColorbox._zoomIn.setAttribute('aria-label','zoom in');
				LyteColorbox._zoomIn.setAttribute('role','button');
			}
			if(LyteColorbox._zoomOut){
				...
				LyteColorbox._zoomOut.setAttribute('tabindex',4);
				LyteColorbox._zoomOut.setAttribute('aria-label','zoom out');
				LyteColorbox._zoomOut.setAttribute('role','button');
			}
			if(LyteColorbox._reset){
				LyteColorbox._reset.addEventListener('click',function(){
					LyteColorbox.reset(null ,true);
				},true)
				LyteColorbox._reset.setAttribute('aria-label','reset');
				LyteColorbox._reset.setAttribute('tabindex',4);
				LyteColorbox._reset.setAttribute('role','button');
			}
		}
		else{
