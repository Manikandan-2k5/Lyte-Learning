...
_template:"<template tag-name=\"lyte-slider\"> <div class=\"lyteSlide {{if(ltPropDisabled,'lyteSliderDisabled','')}}\"> <div class=\"lyteRangeSlider {{ltPropDirection}}\" tabindex=\"0\" __click=\"{{action('click',event)}}\" __keydown=\"{{action('keydown',event)}}\"> <div class=\"lyteSliderFill\"></div> <div class=\"lyteSliderHandler {{ltPropHandler}} lyteHandler1\" lt-prop-title=\"{{if(expHandlers(ltPropTooltip,'&amp;&amp;',true),if(ltPropRangeHandler,ltPropMinValue,ltPropValue),'')}}\" tabindex=\"0\" ontouchstart=\"{{action('mousedown',event,this)}}\" lt-prop-tooltip-config=\"{{ltPropTooltipConfig}}\" lt-prop-tooltip-style=\"{{ltPropTooltipStyle}}\" lt-prop-tooltip-class=\"{{ltPropTooltipClass}}\" style=\"border-color: {{ltPropFillColor}}\" __mousedown=\"{{action('mousedown',event,this)}}\"></div> <template is=\"if\" value=\"{{ltPropRangeHandler}}\"><template case=\"true\"> <div class=\"lyteSliderHandler {{ltPropHandler}} lyteHandler2\" tabindex=\"0\" ontouchstart=\"{{action('mousedown',event,this)}}\" lt-prop-title=\"{{if(ltPropTooltip,ltPropMaxValue,'')}}\" lt-prop-tooltip-config=\"{{ltPropTooltipConfig}}\" lt-prop-tooltip-style=\"{{ltPropTooltipStyle}}\" lt-prop-tooltip-class=\"{{ltPropTooltipClass}}\" style=\"border-color: {{ltPropFillColor}}\" __mousedown=\"{{action('mousedown',event,this)}}\"></div> </template></template><template is=\"if\" value=\"{{ltPropYield}}\"><template case=\"true\"> <lyte-yield yield-name=\"yield\" lt-prop-scale-value=\"{{scaleVal}}\" lt-prop-scale-style=\"{{divLength}}\"></lyte-yield> </template><template case=\"false\"> <div class=\"lyteScaleOption {{ltPropHandler}}\"> <template is=\"for\" items=\"{{divLength}}\" index=\"indexVal\"> <span class=\"lyteScaleLine\" style=\"{{item}}\"> <span></span> <span class=\"lyteScalLable\">{{scaleVal[indexVal]}}</span> </span> </template> </div> </template></template> </div> </div> </template>",
_dynamicNodes : [{"type":"attr","position":[1]},{"type":"attr","position":[1,1]},{"type":"attr","position":[1,1,3],"attr":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'border-color: '","ltPropFillColor"]}}}},{"type":"attr","position":[1,1,5]},{"type":"if","position":[1,1,5],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1],"attr":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'border-color: '","ltPropFillColor"]}}}}]}},"default":{}},{"type":"attr","position":[1,1,6]},{"type":"if","position":[1,1,6],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"insertYield","position":[1]}]},"false":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1]},{"type":"for","position":[1,1],"dynamicNodes":[{"type":"attr","position":[1],"attr":{"style":{"name":"style","dynamicValue":"item"}}},{"type":"text","position":[1,3,0]}]}]}},"default":{}}],
_observedAttributes :["divLength","scaleVal","ltPropMin","ltPropMax","ltPropScaleInterval","ltPropStep","ltPropHandler","ltPropDirection","ltPropWidth","ltPropFillColor","ltPropNonFillColor","ltPropHeight","ltPropValue","ltPropDiscrete","ltPropContent","ltPropRangeHandler","ltPropMinValue","ltPropMaxValue","ltPropDisabled","ltPropSelectedValue1","ltPropSelectedValue2","ltPropYield","ltPropTooltipStyle","ltPropTooltip","ltPropScaleUnit","ltPropTooltipClass","ltPropTooltipConfig","ltPropMinDiff","ltPropDigits","preventObs"],
        ...
        actions:{
            ...
            keydown : function( evt ){
                ...
                if( !/^3(3|4|5|6|7|8|9)|40$/.test( keycode ) || ( /^37|39$/.test( keycode ) && !is_hori ) || ( /^38|40$/.test( keycode ) && is_hori ) ){
                    return;
                }
