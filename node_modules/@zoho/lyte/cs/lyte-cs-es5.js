  ...
  */
    ...
    _createClass(customElementPrototype, [{
      ...
      value: function afterConnected(fastRenderProp, ssrBind) {
        ...
        for (var _i5 = 0; _i5 < obsattr.length; _i5++) {
          var _key8 = obsattr[_i5];
          var prop = this.getProperty(_key8);
        ...
        if (this._initProperties) {
          ...
          for (var _key9 in initProperties) {
            var actVal = void 0;
            var _field2 = compInstance.__data[_key9];
            if (_field2 && _field2.type !== _LC.getDataType(initProperties[_key9]) && (initProperties[_key9] !== undefined || _field2.type === "boolean")) {
              actVal = _LC.typeCast(initProperties[_key9], compInstance.__data[_key9].type);
            } else {
              actVal = initProperties[_key9];
            }
            // if(field){
            var error = _LC.handleValidation(compData, _key9, actVal, compInstance, true);
            if (!error) {
              compData[_key9] = actVal;
              var customDtype;
              ...
              if (_field2 && /^(object|array)$/.test(_field2.type) && _field2.watch || customDtype) {
                Lyte.establishObjectBinding(compData, _key9, undefined, undefined, undefined, _field2.watch ? true : undefined);
              }
            }
            // }
          }
        ...
        if (this._initMethods) {
          ...
          for (var _key10 in initMethods) {
            compInstance.$node._methods[_key10] = initMethods[_key10];
          }
      ...
      value: function initializeMethod(node, actMethods) {
        ...
        for (var _key11 in actMethods) {
          compInstance.methods[_key11] = actMethods[_key11];
        }
        var met = compInstance.methods;
        Object.defineProperty(compInstance, "methods", {
          get: function get() {
      ...
      value: function renderComponent(dynNode, preDefObj) {
        ...
        for (var _key12 in data) {
          component.data[_key12] = data[_key12][def];
        }
        ...
        if (initProperties) {
          for (var _key13 in initProperties) {
            var actVal = void 0;
            if (component.__data[_key13] && component.__data[_key13].type !== _LC.getDataType(initProperties[_key13]) && (initProperties[_key13] !== undefined || component.__data[_key13].type === "boolean")) {
              actVal = _LC.typeCast(initProperties[_key13], component.__data[_key13].type);
            } else {
              actVal = initProperties[_key13];
            }
            var error = _LC.handleValidation(component.data, _key13, actVal, component);
            if (!error) {
              component.data[_key13] = actVal;
            }
          }
        }
        if (true) {
                ...
                case "forIn":
                  {
                    ...
                    if (object && (objKeys = Object.keys(object))) {
                      ...
                      for (var keyIndex = 0; keyIndex < objKeys.length; keyIndex++) {
                        var _key14 = objKeys[keyIndex];
                        compData[valueKey] = object[_key14];
                        compData[keyKey] = _key14;
                ...
                case "insertYield":
                  {
                    ...
                    if (yieldObj) {
                      ...
                      for (var _key15 in contextSwitch) {
                        parentScope.component.data[_key15] = contextSwitch[_key15];
                      }
                      if (yieldObj._cx) {
      ...
      value: function renderNodes(toAppend, dynamicNodes, helperNode, options, establishBindings, returnVal, templateContent) {
        ...
        for (var _i7 = 0; _i7 < dynamicNodes.length; _i7++) {
          ...
          if (type === "componentDynamic") {
            ...
            var toBeRemoved = [];
            for (var _key16 in info.attr) {
              var _attr2 = info.attr[_key16];
              ...
              if (_attr2 && (_attr2.dynamicValue || _attr2.helperInfo)) {
                ...
                if (!_attr2.globalEvent) {
                  ...
                  var node = this.bindNode(dynamicN.attributes.getNamedItem(attrName), toBeRemoved, helperNode, options, _attr2, undefined, establishBindings, undefined, dynamicNodes._cache, type, _i7);
        ...
        if (isCustomProp !== -1) {
          ...
          if (lyteProps) {
            try {
              ...
              for (var _key17 in lyteProps) {
                var actKey = propValue + _LC.String.upperCaseFirstLetter(_key17);
                this.set(actKey, lyteProps[_key17]);
              }
            } catch (e) {
      ...
      value: function removeHelpers(node, update, direct) {
        ...
        if (node._forContent) {
          if (node.getAttribute("is") === "for") {
            ...
            if (node._items.length) {
              ...
              if (prop) {
                for (var _i15 = 0; _i15 < node._items.length; _i15++) {
                  this.removeBindings(_defineProperty({}, _key18, node._items[_i15].itemProperty), _defineProperty({}, _key18, node._attributes.items[_i15]));
                }
              }
            }
            if (!update) {
            ...
            var _key19 = node.getAttribute("key");
            for (var index in items) {
              ...
              if (_prop) {
                this.removeBindings(_defineProperty({}, _key19, node._items[index].itemProperty), _defineProperty({}, _key19, node._attributes.object[index]));
              }
            }
            if (!update) {
              if (node._actualBinding) {
          ...
          if (node._caseContent) {
            ...
            for (var _key20 in node._dynamicProperty) {
              if (node._dynamicProperty[_key20].isActualNode) {
                node._dynamicProperty[_key20].isActualNode._helperNodes[del](node);
              } else {
                var helperNodes = this.getProperty(_key20)._helperNodes;
                if (helperNodes) {
          ...
          for (var _key21 in node._renderedComponent) {
            if (node._renderedComponent[_key21]) {
              node._renderedComponent[_key21].remove();
              node._renderedComponent[_key21] = null;
            }
          }
        }
      ...
      value: function updateForHelper(node, options, contextSwitchInfo, establishBindings, staticTempArr) {
        ...
        if (options) {
          switch (options.type) {
            ...
            case "update":
              {
                var _key22 = node.getAttribute("item");
        ...
        if (options.type !== "remove") {
          ...
          for (var _k5 = firstIndexForIteration, _v4 = lastIndexForIteration; _v4 > 0; _k5++, _v4--) {
            ...
            for (var d = 0; d < dynProps.length; d++) {
              var _key23 = dynProps[d];
              node._dynProps[_key23] ? node._dynProps[_key23]++ : node._dynProps[_key23] = 1;
            }
      ...
      value: function actualConnectedCallback() {
        ...
        if (templateAttributes && templateAttributes.attr) {
          for (var _key24 in templateAttributes.attr) {
            //        		let attr = templateAttributes.attr[i];
            var attr = templateAttributes.attr[_key24];
            if (!this.hasAttribute(attr.name) && !compData.hasOwnProperty(attr.name) || attr.globalEvent) {
              ...
              if (!attr.globalEvent) {
                attr.from = "component";
                if (attr.staticValue) {
                  this.setAttribute(templateAttributes.attr[_key24].name, attr.staticValue);
                } else {
                  this.setAttribute(templateAttributes.attr[_key24].name, "{{dummy}}");
                  this.bindNode(this.attributes.getNamedItem(templateAttributes.attr[_key24].name), [], undefined, {}, templateAttributes.attr[_key24], undefined, undefined, true);
                }
              }
            }
          }
        }
        for (var _key25 in this._toRegEvnts) {
          this.addEventListener(_key25, this._toRegEvnts[_key25].listener);
          if (this.hasAttribute(_key25)) {
            this.setAttribute(_key25, this.getAttribute(_key25) + " ; " + this._toRegEvnts[_key25].attrVal);
          } else {
            this.setAttribute(_key25, this._toRegEvnts[_key25].attrVal);
          }
        }
        this._toRegEvnts = {};
        var initialUnbound = _LC.unbound;
        ...
        for (key in self.__dc) {
          ...
          if (helper.hasAttribute("lyte-keep-alive")) {
            ...
            for (var j = 0; j < objKeys.length; j++) {
              var _key26 = objKeys[j];
              if (_key26 !== helper._currentComponent) {
                // Will remove from hDiv.
                helper._renderedComponent[_key26].remove();
              }
            }
          }
        }
      ...
      value: function disconnectedCallback() {
        ...
        for (var _key27 in this._properties) {
          this._properties[_key27] = {};
        }
  ...
  var LyteComponent = {
    ...
    "updateCustomCrmComponent": function updateCustomCrmComponent(def, customCrmComponent) {
      for (var _key28 in def) {
        if (def[_key28] && def[_key28].type === "observer") {
          def[_key28].fnName = _key28;
          customCrmComponent._observers.push(def[_key28]);
        } else if (def[_key28] && def[_key28].type === "callBack") {
          var props = def[_key28].properties;
          for (var k = 0; k < props.length; k++) {
            if (!customCrmComponent._callBacks[props[k]]) {
              customCrmComponent._callBacks[props[k]] = [];
            }
            def[_key28].fnName = _key28;
            customCrmComponent._callBacks[props[k]].push(def[_key28]);
          }
          if (def[_key28].observes) {
            def[_key28].observes.fnName = _key28;
            customCrmComponent._observers.push(def[_key28].observes);
          }
        } else {
          customCrmComponent.component.prototype[_key28] = def[_key28];
        }
      }
      return def;
    },
    ...
    "set": function set(object, property, value, options, fromStore, fromParent) {
      ...
      if ((typeof property === 'undefined' ? 'undefined' : _typeof(property)) === "object") {
        if (_Lyte.isRecord(object) && !fromStore && !object.$.isCloned) {
          ...
          //     }
          // }
          for (var _key29 in property) {
            var locValue = property[_key29];
            var dataType = object.$.model.fieldList[_key29];
            ...
            if (dataType && (locValue !== undefined || dataType === "boolean") && dataType !== _LC.getDataType(locValue)) {
              property[_key29] = _LC.typeCast(locValue, dataType);
            }
          }
          ...
          for (var _key30 in property) {
            ...
            _LC.set(object, _key30, property[_key30], value, fromStore, fromParent);
          }
        }
      } else {
              ...
              for (var _i59 = 0; _i59 < objbind.length; _i59++) {
                ...
                for (var _key31 in item) {
                  ...
                  if (!isNaN(parsedKey) && _cond) {
                    ...
                    this.removeSelectedBindingDeep(item[_key31], _oldObject);
                    if (item[_key31]._forHelpers) {
                      var bindfor = item[_key31]._forHelpers.toArrayLyte();
                    ...
                    if (array[parsedKey] && _typeof(array[parsedKey]) === "object") {
                      ...
                      this.establishBindings({ "dummy": item[_key31] }, { "dummy": array[parsedKey] });
                    }
                    this.affectChanges(item[_key31], undefined, _oldObject, undefined, array[parsedKey]);
                    if (options.secondIndex == 1) {
                      break;
                    }
                  }
              ...
              for (var _i61 = 0; _i61 < _objbind3.length; _i61++) {
                ...
                if (_item5._forHelpers) {
                  ...
                  for (var _j6 = 0; _j6 < _helperbind.length; _j6++) {
                    ...
                    for (var _i62 = _index3, _j7 = 0; _i62 < _finalIndex; _i62++, _j7++) {
                ...
                for (var _key32 in _item5) {
                  var _parsedKey = parseInt(_key32);
                  var cond = _options.secondIndex == _options.thirdIndex ? _key32 >= _options.firstIndex && _key32 < _options.firstIndex + _options.secondIndex : _parsedKey >= _options.firstIndex;
                  if (!isNaN(_parsedKey) && cond) {
                    ...
                    this.removeSelectedBindingDeep(_item5[_key32], _oldObject2);
                    if (_item5[_key32]._forHelpers) {
                      var _bindfor = _item5[_key32]._forHelpers.toArrayLyte();
                    ...
                    if (array[_parsedKey] && _typeof(array[_parsedKey]) === "object") {
                      ...
                      this.establishBindings({ "dummy": _item5[_key32] }, { "dummy": array[_parsedKey] });
                    }
                    this.affectChanges(_item5[_key32], undefined, _oldObject2, undefined, array[_parsedKey]);
                  }
                }
              }
            }
              ...
              for (var _i63 = 0; _i63 < _objbind4.length; _i63++) {
                ...
                if (_item7._forHelpers) {
                  ...
                  for (var _j8 = 0; _j8 < _helperbind2.length; _j8++) {
                    ...
                    for (var _i64 = _index4, _j9 = 0; _i64 < _finalIndex2; _i64++, _j9++) {
                ...
                for (var _key33 in _item7) {
                  var _parsedKey2 = parseInt(_key33);
                  if (!isNaN(_parsedKey2) && _parsedKey2 >= _options2.firstIndex) {
                    ...
                    this.removeSelectedBindingDeep(_item7[_key33], _oldObject3);
                    if (_item7[_key33]._forHelpers) {
                      var _bindfor2 = _item7[_key33]._forHelpers.toArrayLyte();
                    ...
                    if (array[_parsedKey2] && _typeof(array[_parsedKey2]) === "object") {
                      ...
                      this.establishBindings({ "dummy": _item7[_key33] }, { "dummy": array[_parsedKey2] });
                    }
                    this.affectChanges(_item7[_key33], undefined, _oldObject3, undefined, array[_parsedKey2]);
                  }
                }
              }
            }
        ...
        case "insertAt":
          {
            ...
            for (var _i66 = _index5; _i66 > array.length; _i66--) {
            ...
            if (array._bindings) {
              ...
              for (var _i67 = 0; _i67 < arrbind.length; _i67++) {
                ...
                for (var _key34 in _item9) {
                  var _parsedKey3 = parseInt(_key34);
                  if (!isNaN(_parsedKey3) && _parsedKey3 >= _options3.firstIndex) {
                    this.removeSelectedBindingDeep(_item9[_key34], array[_parsedKey3 + _options3.secondIndex]);
                    if (_item9[_key34]._forHelpers) {
                      var _bindfor3 = _item9[_key34]._forHelpers.toArrayLyte();
                    ...
                    if (array[_parsedKey3] && _typeof(array[_parsedKey3]) === "object") {
                      ...
                      this.establishBindings({ "dummy": _item9[_key34] }, { "dummy": array[_parsedKey3] });
                    }
                    this.affectChanges(_item9[_key34], undefined, array[_parsedKey3 + _options3.secondIndex], undefined, array[_parsedKey3]);
                  }
                }
              }
            }
    ...
    "removeAllBindings": function removeAllBindings(properties, data) {
      var del = "delete";
      for (var _key35 in properties) {
        if (data[_key35] && data[_key35]._bindings) {
          //                    data[key]._bindings[del](properties[key]);
          //                    if(!data[key]._bindings.size) {
          //                        delete data[key]._bindings;
          //                    }
          deleteBindingCheckSize(data[_key35], "_bindings", properties[_key35]);
        }
        if (data[_key35] && typeof data[_key35] !== "string") {
          _LC.removeAllBindings(properties[_key35], data[_key35]);
        }
      }
    },
    "affectChanges": function affectChanges(item, contextAlreadySwitched, oldValue, setterScope, newValue, callLengthObserver) {
      ...
      if (item._helperNodes) {
        ...
        for (var _s3 = 0; _s3 < itemHelperNodes.length; _s3++) {
          ...
          if (itemHelperNodes[_s3].getAttribute("is") === "for" && itemHelperNodes[_s3]._items) {
            ...
            for (var _key36 in itemHelperNodes[_s3]._items) {
              _callee5.component.data[_itemValue4] = object[_key36];
              _callee5.component.data[_indexValue] = _key36;
              _callee5._properties[_itemValue4] = itemHelperNodes[_s3]._items[_key36].itemProperty;
              if (itemHelperNodes[_s3]._items[_key36]._dynamicProperty[propPath]) {
                nodes = itemHelperNodes[_s3]._items[_key36]._dynamicProperty[propPath];
      ...
      if (Array.isArray(item)) {
        for (var i = 0; i < item.length; i++) {
          for (var _key37 in item[i]) {
            this.affectChanges(item[i][_key37], true, oldValue ? oldValue[i] ? oldValue[i][_key37] : oldValue[i] : oldValue, setterScope, newValue ? newValue[i] ? newValue[i][_key37] : newValue[i] : newValue);
          }
        }
      } else {
        for (var _key38 in item) {
          var oldV = oldValue ? oldValue[_key38] : oldValue,
              newV = newValue ? newValue[_key38] : newValue;
          if (_key38 == "*" && item[_key38].hasOwnProperty("_observers")) {
            oldV = oldValue;
            newV = newValue;
          }
          this.affectChanges(item[_key38], true, oldV, setterScope, newV);
        }
      }
    },
    ...
    "get": function get(context, path, ac, cache) {
      ...
      if (cache && cache.hasOwnProperty(path)) {
        ...
        try {
          ...
          for (var _i83 = 1; _i83 < _arr2.length; _i83++) {
            var locVal = _arr2[_i83];
    ...
    "componentSetData": function componentSetData(arg0, arg1, options) {
      if (typeof arg0 === "string") {
        ...
        for (var _key39 in arg0) {
          this.set(_key39, arg0[_key39], arg1);
        }
      }
    },
      ...
      if (node) {
        if (typeof arg0 === "string") {
          ...
          for (var _key41 in arg0) {
            node._methods[_key41] = arg0[_key41];
          }
        }
      }
    },
        ...
        case "switch":
          {
            ...
            if (_Lyte._ms) {
              ...
              for (var _key42 in info.cases) {
                var _contentNewCompile2 = void 0;
                if (actualTemplateNewCompile) {
                  _contentNewCompile2 = _LC.getContentForIE(actualTemplateNewCompile.querySelector("[case='" + LyteComponent.cssEscape(_key42) + "']"));
                }
                content = _LC.getContentForIE(dynNContent.querySelector("[case='" + _LC.cssEscape(_key42) + "']"), undefined, true);

                setHT(content, info.cases[_key42], _contentNewCompile2, constr);
                doCompile(content.tagName === "TEMPLATE" ? content.content : content, info.cases[_key42].dynamicNodes, componentName, constr, _contentNewCompile2);
                if (actualTemplateNewCompile) {
                  info.cases[_key42]._sta = _LC.processStatic(_contentNewCompile2);
                }
                if (info.cases[_key42]._ht) {
                  info.cases[_key42]._ht = content.cloneNode(true);
                  constr._helperTemplate.content.append(info.cases[_key42]._ht);
                  content.innerHTML = "";
                }
              }
              if (info[def].dynamicNodes) {
    ...
    value: function value(arg0, arg1) {
      ...
      if (typeof arg0 === "string") {
        ...
        for (var _key43 in arg0) {
          this._initProperties[_key43] = arg0[_key43];
        }
      }
    }
  });
    ...
    value: function value(arg0, arg1) {
      ...
      if (typeof arg0 === "string") {
        ...
        for (var _key44 in arg0) {
          this._initMethods[_key44] = arg0[_key44];
        }
      }
    }
  });
